...
export function Navbar() {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            // Updates 'isScrolled' to true if the scroll position is greater than 10
        ...
        // Cleanup function to remove the event listener when the component unmounts or before re-running the effect
                ...
                <div className="flex flex-wrap justify-between items-center max-w-6xl mx-auto">
                    <div className='flex items-center'>
                        <Link href={"/"} className='flex items-center space-x-2'>
                            ...
                            <span className='text-xl sm:text-2xl font-bold text-white'>ContentCrafter</span>
                        </Link>
                    </div>

                    {/* Menu icon for smaller device*/}
